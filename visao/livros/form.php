...
<div class="container">
  ...
  <form method="post">
    ...
    <input type="number" name="ano_publicacao" placeholder="Ano de Publicação" value="<?= $livro['ano_publicacao'] ?>">
    <input type="text" name="editora" placeholder="Editora" value="<?= $livro['editora'] ?>">
    <input type="text" name="status_leitura" placeholder="Status de Leitura" value="<?= $livro['status_leitura'] ?>">
